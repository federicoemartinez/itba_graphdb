...
Actualmente existe una amplia variedad de BDG, tanto de codigo abierto como propietario y muchas de ellas pueden manejar, en mayor o menor medida, datos espaciales. Entre ellas podemos citar a Neo4j, ArangoDB, OrientDB, Titan, etc.
...
Neo4j por su parte brinda un soporte mucho mas avanzado para el manejo de datos geograficos, posibilitando realizar consultas mas complejas de manera eficiente.
